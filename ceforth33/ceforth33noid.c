...
/* Andras Pahi                                                                */
/* 20aug26ap                                                                  */
/* Removed the complex pre/post-increment/decrement expressions.              */
/* Chen-Hanson Ting                                                           */
...
# define	pop	    top = stack[PTR(S)]; S--
# define	push	S++; stack[PTR(S)] = top; top =
# define	popR    rack[PTR(R)]; R--
# define	pushR   R++; rack[PTR(R)]
...
case 49: // mod
{
	top = (top) ? stack[PTR(S)] % top : stack[PTR(S)]; S--;
}
break;
case 50: // slash
{
	top = (top) ? stack[PTR(S)] / top : (stack[PTR(S)], 0); S--;
}
break;
case 51: // umsta
{
...
case 57: // pstor
{
	data[top >> 2] += stack[PTR(S)], S--, pop;
}
break;
case 58: // dstor
{
	data[top >> 2] = stack[PTR(S)]; S--;
	data[(top >> 2) + 1] = stack[PTR(S)]; S--;
	pop;
}
break;
case 59: // dat
